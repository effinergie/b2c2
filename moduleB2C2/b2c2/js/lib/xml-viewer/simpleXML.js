            ...
            case 1: // Simple element
                {
                    ...
                    if (expandingNode)
                        $(expanderSpan).addClass("simpleXML-expander-"+ (bCollapse ? "collapsed" : "expanded"));
                    ...
                    if (hasChildNodes) {
                        ...
                        if (expandingNode) {
                            ...
                            var closeExpander = makeSpan("", "simpleXML-expanderClose");
                            ...
                            parent.appendChild(closeExpander);
                        }
                        else {
